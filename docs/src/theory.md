...
Then it's obvious that the polynomial addition and subtraction should be $$(x\pm y)_k=x_k\pm y_k$$

And with some derivation we can also get the polynomial multiplication rule $$(x\times y)_k=\sum_{i=0}^kx_iy_{k-i}$$
